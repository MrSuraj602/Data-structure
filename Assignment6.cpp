...
int main() {
 ...
 cin >> jobname;
 myPrinter.addjob(jobname);
 break;
 case 2:
 myPrinter.processjob();
 break;
 case 3:
 myPrinter.showjob();
 break;
...
4. Exit
Choose an option: 2
Processing print job: job1
1. Add Print job
2. Process print job
3. Show all print jobs
4. Exit
Choose an option: 2
Processing print job: jon2
1. Add Print job
2. Process print job
3. Show all print jobs
4. Exit
